...
@section('contenido')
	<section>		
		<article class="item registro">
			{{ Form::model($user, ['route'=>'updatePerfilForaneo', 'method'=>'PUT', 'enctype'=>'multipart/form-data']) }}
			...
			<div class="info-item height-auto margin-left">
				...
				{{ Form::text('institucion_procedencia', null, ['class'=> 'input usuario', 'placeholder'=>'Institucion de procedencia']) }}
				{{ $errors->first('institucion_procedencia', '<p class="error">:message</p>') }}
				...
				{{Form::label('ficha1', 'Ficha de deposito')}}
				{{ Form::file('ficha1', ['class'=>'input', 'accept'=>'image/*', 'title'=>'Ficha de deposito']) }}
				{{ $errors->first('ficha1', '<p class="error">:message</p>') }}
